...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Kéo &amp; Thả tập tin</b></span>",
            uploadStr:"Tải lên",
            abortStr: "Dừng tải lên",
            cancelStr: "Hủy",
            deletelStr: "<i class='fa fa-trash-o'></i>",
            doneStr: "Done",
            multiDragErrorStr: "Không Kéo &amp; Thả nhiều tập tin cùng lúc.",
            extErrorStr: "không được kích hoạt. Bộ phận mở rộng: ",
            duplicateErrorStr: "không thành công. Tập tin đã tồn tại.",
            sizeErrorStr: "không thành công. Kích thước tối đa: ",
            uploadErrorStr: "Không thể tải lên.",
            maxFileCountErrorStr: " không thành công. Số tập tin tối đa:",
            downloadStr: "Tải về",
	   ...
	   this.startUpload = function () {
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            var fileInputStr = "<input type='file' class='btn btn-white btn-sm' id='" + fileUploadId + "' name='" + s.fileName + "' accept='" + s.acceptFiles + "'/>";
            if(s.multiple) {
                if(s.fileName.indexOf("[]") != s.fileName.length - 2) // if it does not endwith
                {
                    s.fileName += "[]";
                }
                fileInputStr = "<input type='file' role='button' class='btn btn-white btn-sm' id='" + fileUploadId + "' name='" + s.fileName + "' accept='" + s.acceptFiles + "' multiple/>";
            }

    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jqueryform").Include(
                "~/Scripts/plugins/jquery-form/jquery.form.js"));
            ...
            bundles.Add(new StyleBundle("~/plugins/dataPickerStyles").Include(
                      "~/Content/plugins/datapicker/bootstrap-datepicker.min.css"));

            // dataPicker 
            bundles.Add(new ScriptBundle("~/plugins/dataPicker").Include(
                      "~/Scripts/plugins/datapicker/bootstrap-datepicker.min.js",
                      "~/Scripts/plugins/datapicker/bootstrap-datepicker.vi.min.js"));

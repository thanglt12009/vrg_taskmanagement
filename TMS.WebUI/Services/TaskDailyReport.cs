...
namespace TMS.WebApp.Services
{
    public class TaskDailyReport
    {
        ...
        public TaskDailyReport(DateTime day, Account user)
        {
            _reportTime = day;
            _user = user;
        ...
        public bool prepareReport()
        {
            ...
            strTempFile = Path.Combine(_tempPath, "Báo cáo công văn ngày " + strDate + " " + _user.DisplayName2 + ".xlsx");
